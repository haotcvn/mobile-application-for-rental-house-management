...
import com.tranconghaoit.homemanager.databinding.FragmentNoRoomBinding
...
class NoRoomFragment : Fragment() {
    private var _binding: FragmentNoRoomBinding? = null
    private val binding: FragmentNoRoomBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        return FragmentNoRoomBinding.inflate(inflater, container, false).also {
            _binding = it
        }.root
    }
